...
class MyDataset_shuffle(Dataset):
    ...
    def __getitem__(self, index):
        # ------------------------------------------------------
        #   Use the index to slice the original data into seq_len, label_len, and pred_len
    ...
    def __len__(self):
        #------------------------------------------------
        #   Calculate the number of sliding windows based on the data length
        #------------------------------------------------
...
class MyDataset_stride(Dataset):
    ...
    def __getitem__(self, index):
        e_begin = index
        # ------------------------------------------------------
        #   Use the index to extract seq_len, label_len, and pred_len
    ...
    def __len__(self):
        #------------------------------------------------
        #   Calculate the number of sliding windows considering stride
        #------------------------------------------------
...
class MyDataset_resize_window(Dataset):
    ...
    def __getitem__(self, index):
        ...
        # The index increments by 1, so if you want a specific index, you need to manually adjust the value
        e_begin = index
        # ------------------------------------------------------
        #   Use the index to extract seq_len, label_len, and pred_len
        #   Extract seq_len length from the index
        # ------------------------------------------------------
        e_end = e_begin + self.seq_len
        seq_x = self.data[e_begin:e_end]
        seq_x_mark = self.stamp[e_begin:e_end]
    ...
    def __len__(self):
        #------------------------------------------------
        #   Calculate the number of sliding windows based on the largest prediction length
        #------------------------------------------------
